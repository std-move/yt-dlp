...
from ..audio_languages import ffmpeg_audio_stream_args, language_key
...
class FFmpegMetadataPP(FFmpegPostProcessor):
    ...
    def _get_metadata_opts(self, info):
        ...
        for fmt in info.get('requested_formats') or [info]:
            ...
            # Codes without an actual language (e.g. 'und', 'mul') are kept as they are
            lang = language_key(fmt) or fmt.get('language')
